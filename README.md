...
<p align="center">
  <a href="https://doi.org/10.5281/zenodo.21893199"><img alt="Zenodo DOI: 10.5281/zenodo.21893199" src="https://img.shields.io/badge/Zenodo%20DOI-10.5281%2Fzenodo.21893199-1682D4?style=for-the-badge" /></a>
</p>
...
Both host adapters implement the shared `securedme.education.webauth-template.v1` policy and are auditable through the Gateway. That proves policy compatibility, not a deployed Visual Algorithm Designer login. Provider callback, account binding, session expiry, logout, recovery, and accessible browser acceptance remain required before live-login claims.
