...
Project-specific focus: Graph integrity, serialization compatibility, responsive performance, accessible interaction, frontend/backend contract parity, and deterministic algorithm execution.
