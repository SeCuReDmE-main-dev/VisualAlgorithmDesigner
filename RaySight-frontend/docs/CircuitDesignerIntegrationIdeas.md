...
This document outlines potential concepts for integrating the Classical Circuit Designer with the linear Algorithm Builder inside Visual Algorithm Designer.
