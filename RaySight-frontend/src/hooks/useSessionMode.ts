 ...
 *
 * Two session modes: student builder vs teacher workbench.
 ...
 *   - Workbench: pipeline versioning, team dashboard, webhook integration
 */
...
export function initPlaygroundSession(): PlaygroundConfig {
  const config: PlaygroundConfig = {
    mode: 'playground',
    displayName: 'My first VAD algorithm',
    validationProfile: 'educational',
